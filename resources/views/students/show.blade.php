...
@section('content')
    ...
    <x-page-header
        ...
        :subtitle="($self ?? false) ? 'Your public career profile at KIU.' : 'Student profile at KIU — skills, experience, and application history.'"
        icon="bi-person-badge"
        :breadcrumbs="($self ?? false) ? [
    ...
    <div class="kiu-section-card anim-fade-up">
        ...
        <div class="kiu-section-card-body">
            @if($student->applications->isEmpty())
                <div class="p-4 text-white-75">No applications yet.</div>
            @else
